/**
 * UNIFIVE Engine - Floating Dock Controller Subsystem
 * Dock positioning, pointer drag snapping, quadrant calculations, and visual drop markers.
 */
const DockController = {
  ...
  cyclePosition() {
    ...
    this.setPosition(positions[nextIdx]);
    this.savePosition();
